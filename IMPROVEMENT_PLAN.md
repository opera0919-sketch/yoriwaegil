...
### Phase 4 — 마감·품질 ✅ 완료 (2026-06-10)
11. ✅ E3: 영상 분석 Gemini JSON 모드(실패 시 일반 모드 폴백) / ✅ E1: PR 빌드 CI(`ci.yml`) / ✅ E2: 죽은 코드 정리(seed·마이그레이션·localStore 제거)
12. ✅ C6 PWA(manifest·서비스워커·아이콘·오프라인 데이터 캐시) / ✅ C8 초성검색 / ✅ C9 기본 정렬=최근 추가순 / ✅ C10 삭제 실행취소 / ✅ C7 메모 복원 / ✅ D1 ESC 닫기·아이콘 버튼화·aria / ✅ D2 다크모드(시스템 설정) / ✅ D3 og 태그
13. ⏸ A4: 동시 수정 병합(RPC 또는 테이블 분리) — 보류. 가족 규모 사용에선 충돌 빈도가 낮고 Realtime이 완화. 사용자 수 늘면 착수
